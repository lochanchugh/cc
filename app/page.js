...
if (batsman === "Data Not Found") {
  ...
  <div className="flex flex-col justify-between p-2">
    ...
    <div className="bg-orange-500 rounded-lg px-2 py-2 mb-0.5 w-fit justify-center place-self-center">
      ...
      <p className="text-lg text-center text-blue-800">{update} | {runrate}</p>
    </div>
...
return (
  <div className="min-h-screen bg-blue-50 dark:bg-blue-100 flex flex-col justify-between p-1">
    ...
    <div className="bg-yellow-400 rounded-lg p-1 text-center border-solid border-4 border-gray-600 w-1/2">
      {Displayscore}
    </div>
  </div>
)
