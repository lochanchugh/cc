...
if (batsman === "Data Not Found") {
  ...
  <div className="flex flex-col justify-between p-4">
    ...
    <div className="grid grid-cols-1 gap-0 mt-0.5 border-0 border-blue-500 justify-items-start">
      ...
      <div className="text-left border-0 border-blue-500 p-3 w-40">
        <table className="w-full">
          <thead>
...
return (
  <div className="min-h-screen bg-blue-50 dark:bg-blue-100 flex flex-col justify-between p-4">
    ...
    <div className="bg-blue-100 rounded-lg p-6 text-center border-solid border-4 border-gray-600 w-fit">
      {Displayscore}
    </div>
  </div>
)
